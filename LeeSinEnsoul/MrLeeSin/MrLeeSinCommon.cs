 ...
 namespace MrLeeSin
{
    ...
    class Common
    {
        ...
        {
            var CusPos = Pos;
            if (ObjectManager.Player.Distance(CusPos) > range) CusPos = ObjectManager.Player.Position.Extend(Game.CursorPosCenter, range);
        ...
        {
            EnsoulSharp.Player.IssueOrder(GameObjectOrder.MoveTo, Pos);
        }
